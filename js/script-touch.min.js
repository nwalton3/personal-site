...
*/
function($){"use strict";$(function(){var width=($("body"),$(window).width()),swipewidth=Math.floor(.16*width);swipewidth>150&&(swipewidth=150),50>swipewidth&&(swipewidth=50),$(".portfolio .project").swipe({swipeLeft:function(){changeSlide()},swipeRight:function(){changeSlide("prev")},triggerOnTouchEnd:!1,threshold:swipewidth})})}(jQuery);/*! 
 * script.js 
 */
