 ...
 * script.js 
 */
var windowHeight=0,speedTest=null,currentBreakpoint=null,headerheight=0,titleheight=0,bottomOffset=10,assetBase="http://static.nkwalton.com/img/";window.localAssets&&(assetBase="img/"),$.hisrc.speedTest({speedTestUri:"http://static.nkwalton.com/img/speed.jpg?n="+Math.random(),speedTestKB:48,speedTestExpireMinutes:5}),$(document).ready(function(){$(".main.portfolio").size()?initPortfolio():loadImages($("img.lazy"),0)});