...
*/
function($){"use strict";$(function(){var width=$(window).width(),swipewidth=Math.floor(.16*width);swipewidth>150&&(swipewidth=150),50>swipewidth&&(swipewidth=50),$(".portfolio .project").swipe({swipeLeft:function(){changeSlide()},swipeRight:function(){changeSlide("prev")},triggerOnTouchEnd:!1,threshold:swipewidth})})}(jQuery);/*! 
 * script.js 
 */
var windowHeight=0,speedTest=null,currentBreakpoint=null,headerheight=0,titleheight=0,bottomOffset=10,assetBase=window.assets?window.assets:"";assetBase+="img/",$.hisrc.speedTest({speedTestUri:"http://nkwalton.brighamyounguniv.netdna-cdn.com/img/speed.jpg?n="+Math.random(),speedTestKB:48,speedTestExpireMinutes:5}),$(document).ready(function(){$(".main.portfolio").size()?initPortfolio():loadImages($("img.lazy"),0),$("body").addClass("load")});