 ...
 *
 */
function($){$.hisrc={bandwidth:null,connectionTestResult:null,connectionKbps:null,connectionType:null,devicePixelRatio:null},$.hisrc.defaults={useTransparentGif:!1,transparentGifSrc:"data:image/gif;base64,R0lGODlhAQABAIAAAMz/AAAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==",minKbpsForHighBandwidth:300,speedTestUri:"50K.jpg",speedTestKB:50,speedTestExpireMinutes:30,forcedBandwidth:!1,srcIsLowResoltion:!0},$.hisrc.speedTest=function(options){$(window).hisrc(options)},$.fn.hisrc=function(options){var settings=$.extend({callback:function(){}},$.hisrc.defaults,options),$els=$(this),connection=navigator.connection||{type:0},isSlowConnection=3==connection.type||4==connection.type||/^[23]g$/.test(connection.type);if($.hisrc.devicePixelRatio=1,void 0!==window.devicePixelRatio)$.hisrc.devicePixelRatio=window.devicePixelRatio;else if(void 0!==window.matchMedia)for(var i=1;2>=i;i+=.5)window.matchMedia("(min-resolution: "+i+"dppx)").matches&&($.hisrc.devicePixelRatio=i);var speedConnectionStatus,speedTestUri=settings.speedTestUri,STATUS_LOADING="loading",STATUS_COMPLETE="complete",LOCAL_STORAGE_KEY="fsjs",initSpeedTest=function(){if(!speedConnectionStatus){if(settings.forcedBandwidth)return $.hisrc.bandwidth=settings.forcedBandwidth,$.hisrc.connectionTestResult="forced",speedConnectionStatus=STATUS_COMPLETE,$els.trigger("speedTestComplete.hisrc"),void 0;if(1===$.hisrc.devicePixelRatio)return $.hisrc.connectionTestResult="skip",speedConnectionStatus=STATUS_COMPLETE,$els.trigger("speedTestComplete.hisrc"),void 0;if($.hisrc.connectionType=connection.type,isSlowConnection)return $.hisrc.connectionTestResult="connTypeSlow",speedConnectionStatus=STATUS_COMPLETE,$els.trigger("speedTestComplete.hisrc"),void 0;try{var fsData=JSON.parse(localStorage.getItem(LOCAL_STORAGE_KEY));if(null!==fsData&&(new Date).getTime()<fsData.exp)return $.hisrc.bandwidth=fsData.bw,$.hisrc.connectionKbps=fsData.kbps,$.hisrc.connectionTestResult="localStorage",speedConnectionStatus=STATUS_COMPLETE,$els.trigger("speedTestComplete.hisrc"),void 0}catch(e){}var endTime,startTime,speedTestTimeoutMS,speedTestImg=document.createElement("img");speedTestImg.onload=function(){endTime=(new Date).getTime();var duration=(endTime-startTime)/1e3;duration=duration>1?duration:1,$.hisrc.connectionKbps=8*1024*settings.speedTestKB/duration/1024,$.hisrc.bandwidth=$.hisrc.connectionKbps>=settings.minKbpsForHighBandwidth?"high":"low",speedTestComplete("networkSuccess")},speedTestImg.onerror=function(){speedTestComplete("networkError",5)},speedTestImg.onabort=function(){speedTestComplete("networkAbort",5)},startTime=(new Date).getTime(),speedConnectionStatus=STATUS_LOADING,"https:"===document.location.protocol&&(speedTestUri=speedTestUri.replace("http:","https:")),speedTestImg.src=speedTestUri+"?r="+Math.random(),speedTestTimeoutMS=1e3*(8*settings.speedTestKB/settings.minKbpsForHighBandwidth)+350,setTimeout(function(){speedTestComplete("networkSlow")},speedTestTimeoutMS)}},speedTestComplete=function(connTestResult,expireMinutes){if(speedConnectionStatus!==STATUS_COMPLETE){speedConnectionStatus=STATUS_COMPLETE,$.hisrc.connectionTestResult=connTestResult;try{expireMinutes||(expireMinutes=settings.speedTestExpireMinutes);var fsDataToSet={kbps:$.hisrc.connectionKbps,bw:$.hisrc.bandwidth,exp:(new Date).getTime()+6e4*expireMinutes};localStorage.setItem(LOCAL_STORAGE_KEY,JSON.stringify(fsDataToSet))}catch(e){}$els.trigger("speedTestComplete.hisrc")}},setImageSource=function($el,src){settings.useTransparentGif?$el.attr("src",settings.transparentGifSrc).css("max-height","100%").css("max-width","100%").css("background",'url("'+src+'") no-repeat 0 0').css("background-size","contain"):$el.attr("src",src)};return settings.callback.call(this),$els.each(function(){var $el=$(this),src=$el.attr("src");src&&($el.data("m1src")||$el.data("m1src",src),!$el.attr("width")&&$el.width()>0&&$el.attr("width",$el.width()),!$el.attr("height")&&$el.height()>0&&$el.attr("height",$el.height()),$el.on("speedTestComplete.hisrc",function(){if(speedConnectionStatus===STATUS_COMPLETE){if(isSlowConnection)$el.attr("src",$el.data("m1src"));else if($.hisrc.devicePixelRatio>1&&"high"===$.hisrc.bandwidth){var image2x=$el.data("2x");image2x||(image2x=$el.data("m1src").replace(/\.\w+$/,function(match){return"@2x"+match})),setImageSource($el,image2x)}else if(settings.srcIsLowResoltion){var image1x=$el.data("1x");image1x||(image1x=$el.data("m1src").replace(/\.\w+$/,function(match){return"@1x"+match})),setImageSource($el,image1x)}$el.off("speedTestComplete.hisrc")}}))}),initSpeedTest(),$els}}(jQuery),/*!
* screenfull
* v1.1.1 - 2013-11-20
* https://github.com/sindresorhus/screenfull.js
* (c) Sindre Sorhus; MIT License
*/
function(window,document){"use strict";var keyboardAllowed="undefined"!=typeof Element&&"ALLOW_KEYBOARD_INPUT"in Element,fn=function(){for(var val,valLength,fnMap=[["requestFullscreen","exitFullscreen","fullscreenElement","fullscreenEnabled","fullscreenchange","fullscreenerror"],["webkitRequestFullscreen","webkitExitFullscreen","webkitFullscreenElement","webkitFullscreenEnabled","webkitfullscreenchange","webkitfullscreenerror"],["webkitRequestFullScreen","webkitCancelFullScreen","webkitCurrentFullScreenElement","webkitCancelFullScreen","webkitfullscreenchange","webkitfullscreenerror"],["mozRequestFullScreen","mozCancelFullScreen","mozFullScreenElement","mozFullScreenEnabled","mozfullscreenchange","mozfullscreenerror"],["msRequestFullscreen","msExitFullscreen","msFullscreenElement","msFullscreenEnabled","MSFullscreenChange","MSFullscreenError"]],i=0,l=fnMap.length,ret={};l>i;i++)if(val=fnMap[i],val&&val[1]in document){for(i=0,valLength=val.length;valLength>i;i++)ret[fnMap[0][i]]=val[i];return ret}return!1}(),screenfull={request:function(elem){var request=fn.requestFullscreen;elem=elem||document.documentElement,/5\.1[\.\d]* Safari/.test(navigator.userAgent)?elem[request]():elem[request](keyboardAllowed&&Element.ALLOW_KEYBOARD_INPUT)},exit:function(){document[fn.exitFullscreen]()},toggle:function(elem){this.isFullscreen?this.exit():this.request(elem)},onchange:function(){},onerror:function(){},raw:fn};return fn?(Object.defineProperties(screenfull,{isFullscreen:{get:function(){return!!document[fn.fullscreenElement]}},element:{enumerable:!0,get:function(){return document[fn.fullscreenElement]}},enabled:{enumerable:!0,get:function(){return!!document[fn.fullscreenEnabled]}}}),document.addEventListener(fn.fullscreenchange,function(e){screenfull.onchange.call(screenfull,e)}),document.addEventListener(fn.fullscreenerror,function(e){screenfull.onerror.call(screenfull,e)}),window.screenfull=screenfull,void 0):(window.screenfull=!1,void 0)}(window,document);/*! 
 * script.js 
 */
var windowHeight=0;$(function(){var url=document.location.toString(),newHash="";if(url.match("#")){var split=url.split("#")[1];url.match("=")&&(split=split.split("=")[0]),gotoSlide(split)}$(window).on("hashchange",function(e){e.preventDefault();var hash=window.location.hash;hash!==newHash&&gotoSlide(hash),newHash=hash}),$("a.infobutton").on("click",function(e){e.preventDefault(),$(".portfolio").toggleClass("show-info")}),$("nav a.next").on("click",function(e){e.preventDefault(),changeSlide()}),$("nav a.prev").on("click",function(e){e.preventDefault(),changeSlide("prev")}),checkHeight(),$(window).on("resize",checkHeight),$("p, .type").each(function(){$(this).html(typogr.typogrify($(this)))})});